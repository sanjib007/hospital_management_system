                            ...
                            <div class="panel-body">
                                ...
                                <div id="priceInfo" style="display: none;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="vtime"  id="vtime" placeholder=" ">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-lg-2" for="vtime">Previous Visit Price</label>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="previous_vist_price"  id="previous_vist_price" placeholder=" ">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-lg-2" for="vtime">Previous Visit Time</label>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="previous_vist_time"  id="previous_vist_time" placeholder=" ">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-lg-2" for="vtime">Doctor Prescribe Info</label>
                                        <div class="col-lg-10">
                                            <textarea name="editor1" class="form-control" id="editor1" rows="10" cols="80">
    ...
    $(document).ready(function() {
        ...
        $("#create_profile").validate({
            rules: {
                ...
                vtime: "required",
                visit: "required",
                previous_vist_price: "required",
                previous_vist_time: "required",
                editor1 : "required"
