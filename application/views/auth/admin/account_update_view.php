            ...
            <div class="panel-body">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body bio-graph-info">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="fname"
                                       value="<?php echo set_value('update_first_name', $user['upro_first_name']); ?>"
                                       id="fname">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="lname"
                                       value="<?php echo set_value('lname', $user['upro_last_name']); ?>" id="lname"
                                       placeholder=" ">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="birthday"
                                       value="<?php echo set_value('birthday', $user['date_of_birth']); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <label class="checkbox-inline">
                                    <input type="radio"
                                           id="gender" <?php if ($user['gender'] == "male") echo ' checked' ?>
                                           name="gender" value="male"> Male
                                </label>
                                <label class="checkbox-inline">
                                    <input type="radio" id="inlineCheckbox2"
                                           name="gender" <?php if ($user['gender'] == "female") echo ' checked' ?>
                                           value="female"> Female
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <select class="form-control" name="blood" id="blood">
                                    <option <?php if ($user['blood_group'] == "") echo ' selected' ?> value="">--Select
                                        One--
                                    </option>
                                    <option <?php if ($user['blood_group'] == "A+") echo ' selected' ?> value="A+">A+
                                    </option>
                                    <option <?php if ($user['blood_group'] == "O+") echo ' selected' ?> value="O+">O+
                                    </option>
                                    <option <?php if ($user['blood_group'] == "B+") echo ' selected' ?> value="B+">B+
                                    </option>
                                    <option <?php if ($user['blood_group'] == "AB+") echo ' selected' ?> value="AB+">
                                        AB+
                                    </option>
                                    <option <?php if ($user['blood_group'] == "A-") echo ' selected' ?> value="A-">A-
                                    </option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="occupation"
                                       value="<?php echo set_value('occupation', $user['occupation']); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="mobile"
                                       value="<?php echo set_value('mobile', $user['upro_phone']); ?>" id="mobile"
                                       placeholder=" ">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="present_address"
                                       value="<?php echo set_value('present_address', $user['present_address']); ?>"
                                       id="present_address" placeholder=" ">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="permanent_address"
                                       value="<?php echo set_value('permanent_address', $user['permanent_address']); ?>"
                                       id="permanent_address" placeholder=" ">
                            </div>
                        </div>
                        <?php
                        ...
                        ?>
                        <div class="form-group">
                            <label class="control-label col-lg-2" for="vtime">Doctor Prescribe Info</label>

                            <div class="col-lg-10">
                                            <textarea name="editor1" class="form-control" id="editor1" rows="10"
                                                      cols="80">
                                    <?php echo $user['doctor_prescribe_info']; ?>
                                            </textarea>
                            </div>
                        </div>
                        <?php } ?>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" name="email" id="email"
                                           value="<?php echo set_value('email', $user['uacc_email']); ?>"
                                           placeholder=" ">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" name="userName" id="userName"
                                           value="<?php echo set_value('userName', $user['uacc_username']); ?>"
                                           placeholder=" ">
                                </div>
                            </div>
                            ...
                            <div id="priceInfo" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="visit" id="visit"
                                               placeholder="enter doctors visit ">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="vtime" value="15" id="vtime"
                                               placeholder=" ">
                                    </div>
                                </div>
                            </div>
